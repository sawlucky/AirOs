      ...
      <div className="container mx-auto px-4 sm:px-[90px] py-8 lg:py-24">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-24">
          ...
          <div className="lg:w-1/2">
            <h1 className="text-4xl md:text-5xl font-bold font-['Poppins'] mb-12">
              Let's discuss <br />
          ...
          <div className="lg:w-1/2">
            <div className="bg-zinc-100 rounded-3xl p-6 md:p-8 lg:p-12">
              <div className="mb-8 lg:mb-12">
                <h2 className="text-black text-base font-medium font-['Poppins'] mb-5">
                  I'm interested in...
                </h2>
                  ...
                  {interest.map((item, index) => (
                    <button
                      ...
                      className={
                        ...
                        "flex-1 min-w-[120px] sm:min-w-[150px] px-3 py-2 sm:px-4 sm:py-3 rounded-md outline outline-[1.61px] text-sm sm:text-base font-medium font-['Poppins'] transition-colors"
                      }
              ...
              <form onSubmit={HandleSubmit}>
                <div className="space-y-6 lg:space-y-9 mb-8 lg:mb-12">
                  <div>
                    <input
                      ...
                      className="w-full h-12 px-4 py-2 bg-white/0 rounded-lg outline outline-1 outline-offset-[-1px] outline-black/30 text-black/70 text-base font-normal font-['Inter'] placeholder-black/70 focus:outline-[#FECC30] focus:outline-2"
                  ...
                  <div>
                    <input
                      ...
                      className="w-full h-12 px-4 py-2 bg-white/0 rounded-lg outline outline-1 outline-offset-[-1px] outline-black/30 text-black/70 text-base font-normal font-['Inter'] placeholder-black/70 focus:outline-amber-400 focus:outline-2"
                  ...
                  <div>
                    <textarea
                      ...
                      rows="4"
                      className="w-full min-h-[100px] px-4 py-2 bg-white/0 rounded-lg outline outline-1 outline-offset-[-1px] outline-black/30 text-black/70 text-base font-normal font-['Inter'] placeholder-black/70 focus:outline-amber-400 focus:outline-2"
                ...
                >
                  ...
                  <span className="text-black text-lg sm:text-xl font-medium font-['Poppins']">
